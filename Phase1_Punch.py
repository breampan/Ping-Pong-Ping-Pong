...
def create_gui():
    root = tk.Tk(); root.title("Ping Pong Ping Pong - Mixer (PUNCH)"); root.geometry("600x500"); root.configure(padx=20, pady=20)
    tk.Label(root, text="第一階段：出拳力度版", font=("Helvetica", 16, "bold")).grid(row=0, column=0, columnspan=4, pady=(0, 20))
    for i in range(1, 5):
        ...
        tk.Label(frame, text="出拳靈敏").pack(pady=(10, 0))
